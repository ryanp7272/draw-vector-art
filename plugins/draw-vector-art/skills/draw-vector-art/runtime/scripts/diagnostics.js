...
import { PALETTE_REF_PATTERN, SceneSchema, } from "./schema.js";
...
function checkPaletteRef(value, scene, pointer, objectId, issues) {
...
function objectOpaqueRectangle(resolved, scene) {
    if (resolved.object.type !== "rectangle" || !resolved.visible)
        return false;
